    ...
    <div class="container">
        <div class="column left">
            <table border="1">
                ...
                <tr>
                    <td>
                        <form action="user_current_scheme - Copy.php" target="displayframe">
                ...
                <tr>
                    <td>
                        <form method="post" action="user_join_scheme (1).php" target="displayframe">
                ...
                <tr>
                    <td>
                        <form method="post" action="user_my_chits (2).php" target="displayframe">
                            <input type="hidden" value="<?php echo $us; ?>" name="username">
